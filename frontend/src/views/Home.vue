<template>
  <div class="h-screen w-screen">
    ...
    <div class="w-screen">
      ...
      <h4 class="text-center text-xl mt-8 text-black">Create questions and learn using active recall.</h4>
      ...
      <div class="bg-gray-100 text-center rounded-lg w-10/12 mx-auto mt-24 p-8">
