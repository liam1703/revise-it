  ...
  <div class="h-screen w-screen bg-slate-100">
    <div class="w-full  pt-24">
      ...
      <div class="bg-white shadow-xl w-96 p-4 rounded-xl mx-auto mt-16">
        <h3 class="mb-3">Register for a Revise-it account.</h3>
        <form>
        ...
        <div class="my-2">
          <router-link to="/login"><p>Have an account already? Click here...</p></router-link>
        </div>
        <div class="mt-12 text-center">
          <button class="border border-solid p-3 rounded background-base text-white" @click="handleSignup">Signup</button>
        </div>
      </form>
      </div>
    </div>
